...
public:
	...
	TestVectorResize(TestVectorResize&& other) : value_(other.value_) { std::cout << "TestVectorResize(TestVectorResize &&other)" << std::endl; }
	TestVectorResize(const TestVectorResize& other) : value_(other.value_) { std::cout << "TestVectorResize(const TestVectorResize& other)" << std::endl; }
