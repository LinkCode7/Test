#ifndef SKIA_SHARED_PTR_H
#define SKIA_SHARED_PTR_H
...
#ifdef _DEBUG
		// SkASSERT(this->getRefCnt() == 1, "fRefCnt was %d", this->getRefCnt());
...
#else
class SkRefCnt : public SkRefCntBase {
